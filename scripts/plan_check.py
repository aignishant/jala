...
CURRICULA: dict[str, tuple[str, list[str]]] = {
    "FOUND": (
        ...
        [
            ...
            "OSI's seven layers vs the Internet's four - which one is real, which one"
            " is vocabulary",
    ...
    "APP": (
        ...
        [
            ...
            "Request smuggling - the desync that lives between Content-Length and"
            " Transfer-Encoding",
    ...
    "WIRE": (
        "Wireless & mobility",
        [
            "The wireless channel - attenuation, interference, multipath, and why it is"
            " not a cable",
    ...
    "DC": (
        ...
        [
            ...
            "Peering, transit and internet exchanges - who pays whom, and why it shows"
            " in traceroute",
    ...
    "OPS": (
        "Operations, troubleshooting & discipline",
        [
...
PHASES: list[Phase] = [
    Phase(
        0,
        "Foundry: the lab, the skeleton, the driver",
        "`./m check` green; `./m lab up two-host` pings; no key and no capture in git",
        [
            d(
                0,
                "Toolchain, skeleton and the `./m` driver - one owner for the environment, a repo "
    ...
    Phase(
        1,
        "The ground: what a network is",
        "`./m lab up two-host` builds two namespaces that ping, and you can name every "
        "header in the capture of that ping",
        [
            d(
                1,
                "Bootstrap & the map - the repo as Jala's memory, the six ledgers, "
                "`scripts/trace.py`, and the ethics rule that governs every packet you will send",
                "OPS-01",
            ),
            d(2, "What a network is, and why it is built in layers", "FOUND-01", "FOUND-02"),
            d(
                3,
                "OSI vs the Internet model, and the envelope inside the envelope",
                "FOUND-03",
                "FOUND-04",
            ),
            d(
                4,
                "Headers, addresses and the five words - frame, packet, segment, datagram, message",
                "FOUND-05",
                "FOUND-06",
                "FOUND-07",
            ),
            d(
                5,
                "Circuit switching, packet switching, and the end-to-end principle",
                "FOUND-08",
                "FOUND-09",
            ),
            d(
                6,
                "How a protocol becomes real - the RFC, and how to read one",
                "FOUND-10",
                "FOUND-11",
            ),
    ...
    Phase(
        2,
        "The wire: signals, errors and the numbers under everything",
        ...
        [
            ...
            d(
                11,
                "Line coding and clock recovery - why the wire never carries your bits raw",
                "PHY-03",
                "PHY-04",
            ),
            ...
            d(
                13,
                "Media and multiplexing - copper, fibre, and one idea in four costumes",
                "PHY-07",
                "PHY-08",
            ),
            ...
            d(
                16,
                "The physical layer you can touch - NICs, transceivers and the cable plant",
                "PHY-12",
            ),
        ],
    ),
    Phase(
        3,
        "The frame: the link layer, built",
        ...
        [
            ...
            d(
                18,
                "The Ethernet frame, built by hand and checked against a capture",
                "LINK-03",
                "LINK-04",
                "LINK-05",
            ),
            ...
            d(
                21,
                "Inside the switch - forwarding modes, buffers, and the duplex mismatch",
                "LINK-09",
                "LINK-22",
            ),
            ...
            d(
                25,
                "ARP, built - and the LAN's complete absence of authentication",
                "LINK-15",
                "LINK-16",
            ),
    ...
    Phase(
        4,
        "The packet: addressing and the network layer",
        ...
        [
            ...
            d(
                33,
                "CIDR, aggregation, and the addresses that are not yours to use",
                "NET-07",
                "NET-08",
            ),
            d(
                34,
                "Longest prefix match, built - and a real routing table read line by line",
                "NET-09",
                "NET-10",
            ),
            ...
            d(
                36,
                "The checksum and fragmentation - two things IPv6 changed its mind about",
                "NET-13",
                "NET-14",
            ),
            ...
            d(40, "IPv6 - the address, the header, and the list of deletions", "NET-20", "NET-21"),
    ...
    Phase(
        5,
        "Routing: how a packet finds a path it was never told about",
        ...
        [
            ...
            d(
                45,
                "The forwarding trie, and choosing between two protocols that disagree",
                "ROUTE-03",
                "ROUTE-04",
            ),
            ...
            d(
                47,
                "Count-to-infinity, reproduced - split horizon, poison reverse, and RIP",
                "ROUTE-06",
                "ROUTE-07",
            ),
            ...
            d(
                49,
                "OSPF - areas, adjacencies, and what convergence actually costs",
                "ROUTE-09",
                "ROUTE-10",
            ),
            d(
                50,
                "Interior and exterior - autonomous systems and the shape of the Internet",
                "ROUTE-11",
                "ROUTE-12",
            ),
            ...
            d(
                52,
                "The BGP decision process, and policy as the real routing metric",
                "ROUTE-15",
                "ROUTE-16",
            ),
    ...
    Phase(
        ...
        [
            d(
                55,
                "Ports and the five-tuple - how a packet finds one process",
                "TRANS-01",
                "TRANS-02",
            ),
            ...
            d(
                58,
                "Reliability from first principles - stop-and-wait, and what sequence numbers cost",
                "TRANS-06",
                "TRANS-07",
            ),
            ...
            d(62, "Teardown, TIME_WAIT, and the port exhaustion it causes", "TRANS-12", "TRANS-13"),
            d(
                63,
                "The byte stream - and the partial read that corrupts your protocol",
                "TRANS-14",
                "TRANS-15",
            ),
            ...
            d(
                65,
                "Retransmission - the RTT estimator, Karn's algorithm, and fast recovery",
                "TRANS-17",
                "TRANS-18",
            ),
            ...
            d(
                67,
                "Nagle meets delayed ACK - the 40 milliseconds nobody ordered",
                "TRANS-21",
                "TRANS-22",
            ),
            d(
                68,
                "Keepalives, half-open connections, and what `close` really does",
                "TRANS-23",
                "TRANS-24",
            ),
        ],
    ...
    Phase(
        7,
        "Congestion: sharing a link nobody owns",
        ...
        [
            d(
                69,
                "Congestion control vs flow control, and the collapse of 1986",
                "CONG-01",
                "CONG-02",
            ),
            ...
            d(
                74,
                "Queues, Little's law, and the bufferbloat on your own link",
                "CONG-09",
                "CONG-10",
            ),
            d(
                75,
                "Active queue management and ECN - dropping early on purpose",
                "CONG-11",
                "CONG-12",
            ),
            d(76, "Fairness, and measuring a congestion controller honestly", "CONG-13", "CONG-14"),
        ],
    ),
    Phase(
        8,
        "The socket API: where your program meets the stack",
        ...
        [
            ...
            d(81, "Completion-based I/O, and the socket options that matter", "SOCK-08", "SOCK-09"),
    ...
    Phase(
        9,
        "Names: DNS, and the answer that never touched the network",
    ...
    Phase(
        10,
        "Applications: the protocols people actually speak",
        ...
        [
            ...
            d(
                93,
                "Methods, status codes, and the two ways to say how long a body is",
                "APP-05",
                "APP-06",
            ),
            ...
            d(
                95,
                "Keep-alive, head-of-line blocking, and the four caches in the path",
                "APP-08",
                "APP-09",
            ),
    ...
    Phase(
        11,
        "Security: the network assumes nothing and trusts nobody",
        ...
        [
            d(
                103,
                "The threat model, and the ethics rule that governs everything after it",
                "SEC-01",
                "SEC-02",
            ),
            ...
            d(
                106,
                "What TLS promises, and the 1.3 handshake read from your own capture",
                "SEC-07",
                "SEC-08",
            ),
            d(107, "Key exchange, the key schedule and the transcript hash", "SEC-09"),
            d(108, "Certificates and the PKI - chains, names and revocation", "SEC-10", "SEC-11"),
            ...
            d(
                115,
                "Segmentation, zero trust, and the capture that contained a password",
                "SEC-21",
                "SEC-22",
            ),
        ],
    ...
    Phase(
        12,
        "Wireless: the link that is not a cable",
        ...
        [
            ...
            d(
                117,
                "Beacons, association, roaming, and what each generation actually changed",
                "WIRE-03",
                "WIRE-04",
            ),
    ...
    Phase(
        13,
        "Datacenter and cloud: networks built for machines, not people",
        ...
        [
            d(
                122,
                "East-west traffic, leaf-spine, and the oversubscription arithmetic",
                "DC-01",
                "DC-02",
            ),
            d(123, "ECMP, elephant flows and incast", "DC-03", "DC-04"),
            d(124, "Overlays - VXLAN, and the MTU that encapsulation costs you", "DC-05", "DC-06"),
    ...
    Phase(
        14,
        "Measurement: numbers you are allowed to quote",
        ...
        [
            ...
            d(
                134,
                "Throughput, goodput, and a harness that reports the spread",
                "PERF-03",
                "PERF-04",
            ),
            d(135, "The benchmark that measured slow start", "PERF-05"),
            d(136, "netem, and capturing without lying to yourself", "PERF-06", "PERF-07"),
            d(137, "The pcap format parsed by hand, and following a stream", "PERF-08", "PERF-09"),
    ...
    Phase(
        15,
        "Operations: the network as something someone has to run",
        ...
        [
            ...
            d(
                145,
                "Monitoring, change windows, and the config that locked you out",
                "OPS-07",
                "OPS-08",
            ),
            d(146, "The incident, the postmortem, and capacity planning", "OPS-09", "OPS-10"),
            d(147, "An IPv6 rollout, and the documents you leave behind", "OPS-11", "OPS-12"),
        ],
    ),
    Phase(
        16,
        "Capstone: the whole path, cold",
        ...
        [
            d(
                148,
                "The cold rebuild - destroy the lab and bring the whole internet back from "
                "committed scripts",
            ),
            d(
                149,
                "One request, every layer - a browser to your own server, annotated from a "
                "single capture",
            ),
            d(
                150,
                "The fault injection audit - five deliberate breakages, diagnosed from "
                "evidence alone",
            ),
            d(
                151,
                "The design document - a network for a stated requirement, with the "
...
def curriculum_tables() -> str:
    ...
    for prefix, (name, concepts) in CURRICULA.items():
        ...
        out.append(
            f"## {section} · Curriculum `{prefix}` — {name} ({prefix}-01..{last.split('-')[1]})\n"
        )
...
def phase_table() -> str:
    ...
    for ph in PHASES:
        ...
        bold = "**" if ph.n == 0 else ""
        out.append(
            f"| {bold}{ph.n}{bold} | {bold}{span}{bold} | {bold}{ph.name}{bold} | {ph.gate} |"
        )
    return "\n".join(out)
...
def day_map() -> str:
    ...
    for ph in PHASES:
        ...
        for day in ph.days:
            marks = "".join(
                m for m, s in (("💥", BURST), ("🅿️", PARKED), ("🔍", COMPARE)) if day.n in s
            )
...
def emit_tables(out_dir: Path) -> None:
    """Write the three generated plan tables into out_dir.

    Every file is opened with an explicit encoding: the tables carry the 💥 / 🅿️ / 🔍
    markers, and Python on Windows defaults to cp1252, which cannot encode them. A bare
    open() here fails with UnicodeEncodeError on exactly the platform this repo runs on.
    """
    ...
    for name, body in (
        ("tables_curricula.md", curriculum_tables()),
        ("tables_phases.md", phase_table()),
        ("tables_daymap.md", day_map()),
    ):
        (out_dir / name).write_text(dash(body), encoding="utf-8")
    print(f"wrote tables_curricula.md, tables_phases.md, tables_daymap.md into {out_dir}")


if __name__ == "__main__":
    verify()
    # Emission is opt-in. `./m plan` runs the verification on every check; writing three
    # generated files into whatever directory the caller happened to be in is a side effect
    # a check must not have.
    if "--emit" in sys.argv:
        emit_tables(Path(__file__).resolve().parents[1] / "docs" / "generated")
